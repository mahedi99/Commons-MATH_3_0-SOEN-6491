...
public class SparseRealVectorTest extends IntermediateRealVectorTests {
    ...
    public void testMapFunctions() {
        testMapFunctionsExtracted(() -> new OpenMapRealVector(vec1), (double[] vat_a) -> new OpenMapRealVector(vat_a),
				(double[] abs_a) -> new OpenMapRealVector(abs_a), (double[] cbrt_a) -> new OpenMapRealVector(cbrt_a),
				(double[] ceil_a) -> new OpenMapRealVector(ceil_a));
    }
