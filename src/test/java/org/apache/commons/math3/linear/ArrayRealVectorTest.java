...
//      Assert.assertEquals("testData not same object ", v1.getDataRef(), vout4.getDataRef());
    ...
    public void testMapFunctions() {
    	 ...
    	 testMapFunctionsExtracted(() -> new ArrayRealVector(vec1), (double[] vat_a) -> new ArrayRealVector(vat_a),
				(double[] abs_a) -> new ArrayRealVector(abs_a), (double[] cbrt_a) -> new ArrayRealVector(cbrt_a),
				(double[] ceil_a) -> new ArrayRealVector(ceil_a));
     
         // create a list to reduce paramaters 
