...
public class IntermediateRealVectorTests {
	...
	protected void testMapFunctionsExtracted(Supplier<RealVector> arg0, Function<double[], RealVector> arg1,
			Function<double[], RealVector> arg2, Function<double[], RealVector> arg3,
			Function<double[], RealVector> arg4) {
		RealVector v1 = arg0.get();
		...
		RealVector vat = arg1.apply(vat_a);
		...
		RealVector abs_v = arg2.apply(abs_a);
		...
		RealVector cbrt_v = arg3.apply(cbrt_a);
		...
		RealVector ceil_v = arg4.apply(ceil_a);
